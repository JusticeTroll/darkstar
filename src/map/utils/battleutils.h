...
class CItemWeapon;
class CMobSkill;
class CTrustWeaponSkill;class CSpell;
class CTrait;
class CWeaponSkill;
...
namespace battleutils
{
    ...
    void            LoadTrustWeaponSkillsList();    void            LoadSkillChainDamageModifiers();
    ...
    bool                CanUseWeaponskill(CTrustEntity* PTrust, CWeaponSkill* PSkill);    int16               CalculateBaseTP(int delay);
