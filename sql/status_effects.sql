...
-- Dumping data for table dspdb.status_effects: 627 rows
...
INSERT INTO `status_effects` (`id`, `name`, `flags`, `type`, `negative_id`, `overwrite`, `block_id`, `remove_id`, `element`, `min_duration`) VALUES
	...
	(1, 'weakness', 8388608, 0, 0, 3, 0, 0, 0, 1),
	(2, 'sleep', 8388656, 2, 19, 1, 193, 0, 8, 1),
	(3, 'poison', 8405024, 0, 0, 2, 0, 0, 3, 1),
	(4, 'paralysis', 8405024, 0, 0, 1, 0, 0, 5, 1),
	(5, 'blindness', 8405024, 0, 0, 1, 0, 0, 8, 1),
	(6, 'silence', 8405024, 0, 0, 2, 0, 0, 4, 1),
	(7, 'petrification', 8388640, 7, 0, 2, 10, 0, 2, 1),
	(8, 'disease', 8409120, 8, 0, 2, 0, 0, 1, 1),
	(9, 'curse', 8405024, 9, 0, 2, 0, 0, 8, 1),
	(10, 'stun', 8388642, 0, 0, 2, 7, 0, 6, 1),
	(11, 'bind', 8405026, 0, 0, 2, 0, 0, 5, 1),
	(12, 'weight', 8405026, 0, 32, 1, 0, 0, 4, 1),
	(13, 'slow', 8405026, 0, 33, 1, 0, 0, 2, 1),
	(14, 'charm', 8388640, 0, 0, 2, 0, 0, 3, 0),
	(15, 'doom', 8388640, 0, 0, 2, 0, 0, 8, 1),
	(16, 'amnesia', 8388640, 0, 0, 2, 0, 0, 1, 1),
	(17, 'charm', 8388640, 0, 0, 2, 0, 0, 3, 0),
	(18, 'gradual_petrification', 8388640, 7, 0, 2, 0, 0, 2, 1),
	(19, 'sleep', 8388656, 2, 0, 1, 0, 0, 8, 1),
	(20, 'curse', 8392736, 9, 0, 2, 0, 0, 8, 1),
	(21, 'addle', 8405026, 0, 0, 2, 0, 0, 1, 1),
	(22, 'intimidate', 32, 0, 0, 2, 0, 0, 0, 1),
	(23, 'kaustra', 8388640, 0, 228, 0, 0, 0, 0, 0),
	(28, 'terror', 8388640, 7, 0, 0, 0, 0, 8, 1),
	(29, 'mute', 8388640, 0, 0, 2, 0, 6, 4, 1),
	(30, 'bane', 8405024, 0, 0, 2, 0, 9, 8, 1),
	(31, 'plague', 8409120, 8, 0, 2, 0, 0, 1, 1),
	(32, 'flee', 33, 0, 12, 0, 0, 0, 4, 0),
	(33, 'haste', 33, 0, 13, 0, 0, 0, 4, 0),
	(34, 'blaze_spikes', 33, 34, 0, 0, 0, 0, 1, 0),
	(35, 'ice_spikes', 33, 34, 0, 0, 0, 0, 5, 0),
	(36, 'blink', 33, 36, 0, 0, 66, 0, 4, 0),
	(37, 'stoneskin', 33, 0, 0, 5, 0, 0, 2, 0),
	...
	(128, 'burn', 8405026, 0, 0, 0, 133, 129, 1, 0),
	(129, 'frost', 8405026, 0, 0, 0, 128, 130, 5, 0),
	(130, 'choke', 8405026, 0, 0, 0, 129, 131, 4, 0),
	(131, 'rasp', 8405026, 0, 0, 0, 130, 132, 2, 0),
	(132, 'shock', 8405026, 0, 0, 0, 131, 133, 6, 0),
	(133, 'drown', 8405026, 0, 0, 0, 132, 128, 3, 0),
	(134, 'dia', 8405026, 0, 135, 0, 0, 0, 7, 0),
	(135, 'bio', 8405026, 0, 134, 0, 0, 0, 8, 0),
	(136, 'str_down', 8405026, 0, 0, 0, 0, 80, 3, 0),
	(137, 'dex_down', 8405026, 0, 0, 0, 0, 81, 2, 0),
	(138, 'vit_down', 8405026, 0, 0, 0, 0, 82, 4, 0),
	(139, 'agi_down', 8405026, 0, 0, 0, 0, 83, 5, 0),
	(140, 'int_down', 8405026, 0, 0, 0, 0, 84, 1, 0),
	(141, 'mnd_down', 8405026, 0, 0, 0, 0, 85, 6, 0),
	(142, 'chr_down', 8405026, 0, 0, 0, 0, 86, 8, 0),
	(143, 'level_restriction', 8388608, 0, 0, 0, 0, 0, 0, 0),
	(144, 'max_hp_down', 8405026, 0, 0, 0, 0, 88, 8, 0),
	(145, 'max_mp_down', 8405026, 0, 0, 0, 0, 89, 7, 0),
	(146, 'accuracy_down', 8405026, 0, 0, 0, 0, 90, 2, 0),
	(147, 'attack_down', 8405026, 0, 0, 0, 0, 91, 3, 0),
	(148, 'evasion_down', 8405026, 0, 0, 0, 0, 92, 5, 0),
	(149, 'defense_down', 8405026, 0, 0, 0, 0, 93, 4, 0),
	...
	(156, 'flash', 8405026, 0, 0, 1, 0, 0, 7, 0),
	(157, 'sj_restriction', 8388608, 0, 0, 0, 0, 0, 0, 0),
	...
	(251, 'food', 8421408, 0, 0, 2, 0, 0, 0, 0),
	(252, 'mounted', 164, 0, 0, 0, 0, 0, 0, 0),
	(253, 'signet', 16777216, 0, 0, 0, 0, 0, 0, 0),
	(254, 'battlefield', 8912896, 0, 0, 0, 0, 0, 0, 0),
	(256, 'sanction', 16777216, 0, 0, 0, 0, 0, 0, 0),
	(257, 'besieged', 0, 0, 0, 0, 0, 0, 0, 0),
	(258, 'illusion', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(259, 'encumbrance', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(260, 'obliviscence', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(261, 'impairment', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(262, 'omerta', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(263, 'debilitation', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(264, 'pathos', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(265, 'flurry', 32, 0, 0, 0, 0, 0, 0, 0),
	(266, 'concentration', 32, 0, 0, 0, 0, 0, 0, 0),
	(267, 'allied_tags', 8912928, 0, 0, 0, 0, 0, 0, 0),
	(268, 'sigil', 16777216, 0, 0, 0, 0, 0, 0, 0),
	(269, 'level_sync', 8388608, 0, 0, 0, 0, 0, 0, 0),
	...
	(276, 'confrontation', 8912928, 0, 0, 0, 0, 0, 0, 0),
	...
	(298, 'critical_hit_evasion_down', 8405026, 0, 0, 0, 0, 0, 0, 0),
	...
	(309, 'bust', 8388896, 0, 0, 4, 0, 0, 0, 0),
	...
	(386, 'lethargic_daze_1', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(387, 'lethargic_daze_2', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(388, 'lethargic_daze_3', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(389, 'lethargic_daze_4', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(390, 'lethargic_daze_5', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(391, 'sluggish_daze_1', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(392, 'sluggish_daze_2', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(393, 'sluggish_daze_3', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(394, 'sluggish_daze_4', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(395, 'sluggish_daze_5', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(396, 'weakened_daze_1', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(397, 'weakened_daze_2', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(398, 'weakened_daze_3', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(399, 'weakened_daze_4', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(400, 'weakened_daze_5', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(401, 'addendum_white', 288, 0, 0, 0, 0, 0, 0, 0),
	(402, 'addendum_black', 288, 0, 0, 0, 0, 0, 0, 0),
	(403, 'reprisal', 33, 34, 0, 0, 0, 0, 0, 0),
	(404, 'magic_evasion_down', 8405026, 0, 0, 0, 0, 0, 0, 0),
	...
	(462, 'conspirator', 33, 0, 0, 0, 0, 0, 0, 0),
	...
	(512, 'ionis', 16777216, 0, 0, 0, 0, 0, 0, 0),
	...
	(557, 'attack_down_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(558, 'defense_down_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(559, 'magic_atk_down_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(560, 'magic_def_down_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(561, 'accuracy_down_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(562, 'evasion_down_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(563, 'magic_acc_down_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(564, 'magic_evasion_down_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(565, 'slow_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(566, 'paralysis_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	(567, 'weight_ii', 8388640, 0, 0, 0, 0, 0, 0, 0),
	...
	(599, 'consume_mana', 33, 0, 0, 0, 0, 0, 0, 0),
	(600, 'runeists_roll', 131360, 0, 0, 0, 0, 0, 0, 0),
	...
	(789, 'field_support_food', 8421408, 0, 0, 2, 0, 0, 0, 0),
