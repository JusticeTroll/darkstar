...
function onTrigger(player,npc)
    ...
    elseif (player:hasKeyItem(dsp.ki.SAN_DORIA_TRUST_PERMIT) == true and player:hasSpell(905) == false) then
        player:startEvent(574,0,0,0,TrustMemory(player),0,0,0,rank6); -- TRUST
