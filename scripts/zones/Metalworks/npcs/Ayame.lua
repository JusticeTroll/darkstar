...
function onTrigger(player,npc)
    ...
    elseif (player:hasKeyItem(dsp.ki.BASTOK_TRUST_PERMIT) == true and player:hasSpell(900) == false) then 
        player:startEvent(985,0,0,0,TrustMemory(player),0,0,0,rank3); --TRUST
    else
