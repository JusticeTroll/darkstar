...
--        end
   ...
   elseif stage == (nyzul.objective.ELIMINATE_SPECIFIED_ENEMY) and progress >= ELIMINATE then
       instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER, 0xFFF), dsp.objType.NPC):AnimationSub(1)
       instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER_START, 0xFFF), dsp.objType.NPC):setLocalVar("Eliminate", 0)
       for i,v in ipairs(chars) do
           v:messageSpecial(ID.text.OBJECTIVE_COMPLETE, instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER_START, 0xFFF), dsp.objType.NPC):getLocalVar("Nyzul_Current_Floor"))
	...
	elseif stage == (nyzul.objective.ELIMINATE_SPECIFIED_ENEMIES) and progress == ELIMINATE then
       instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER, 0xFFF), dsp.objType.NPC):AnimationSub(1)
       instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER_START, 0xFFF), dsp.objType.NPC):setLocalVar("Eliminate", 0)
       for i,v in ipairs(chars) do
           v:messageSpecial(ID.text.OBJECTIVE_COMPLETE, instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER_START, 0xFFF), dsp.objType.NPC):getLocalVar("Nyzul_Current_Floor"))
       end 	   
	elseif stage == (nyzul.objective.ELIMINATE_ENEMY_LEADER) and progress >= 15 then
       instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER, 0xFFF), dsp.objType.NPC):AnimationSub(1)
       instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER_START, 0xFFF), dsp.objType.NPC):setLocalVar("Eliminate", 0)
       for i,v in ipairs(chars) do
           v:messageSpecial(ID.text.OBJECTIVE_COMPLETE, instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER_START, 0xFFF), dsp.objType.NPC):getLocalVar("Nyzul_Current_Floor"))
       end 
    elseif stage == (nyzul.objective.ELIMINATE_ALL_ENEMIES) and progress == ELIMINATE then
        instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER, 0xFFF), dsp.objType.NPC):AnimationSub(1)
        instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER_START, 0xFFF), dsp.objType.NPC):setLocalVar("Eliminate", 0)
        for i,v in ipairs(chars) do
            v:messageSpecial(ID.text.OBJECTIVE_COMPLETE, instance:getEntity(bit.band(ID.npc.RUNE_TRANSFER_START, 0xFFF), dsp.objType.NPC):getLocalVar("Nyzul_Current_Floor"))
...
--        instance:setStage(math.random(nyzul.objective.ELIMINATE_ENEMY_LEADER, nyzul.objective.ELIMINATE_ALL_ENEMIES)) -- pick which objective
        instance:setStage(math.random(nyzul.objective.ELIMINATE_ENEMY_LEADER, nyzul.objective.ELIMINATE_ALL_ENEMIES, nyzul.objective.ELIMINATE_SPECIFIED_ENEMIES, nyzul.objective.ELIMINATE_SPECIFIED_ENEMY)) -- pick which objective  TESTING 
		end
